...
import type { MarketIntelligenceDataResponse } from '@/types/api';
...
export async function GET(
  ...
  try {
    ...
    // 2. Fetch all data required for the market intelligence tab
    ...
    const response: MarketIntelligenceDataResponse = {
