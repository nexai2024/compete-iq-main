...
// ⚡ Bolt: Memoized AnalysisCard to prevent re-renders on filter/sort changes
// This component is wrapped in React.memo to avoid re-rendering when its props
// have not changed, which is common when the parent DashboardPage state updates.
