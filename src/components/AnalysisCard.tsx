...
// ⚡ Bolt: Wrapped with React.memo to prevent unnecessary re-renders from parent components.
// This is effective when the props passed to it are primitive values or memoized.
