...
// ⚡ Bolt: Memoize AnalysisCard to prevent re-renders from parent state changes (e.g., filtering)
// This is effective only when parent components stabilize props (e.g., using useCallback for functions).
