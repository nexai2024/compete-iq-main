...
// ⚡ Bolt: Memoize AnalysisCard to prevent unnecessary re-renders in the dashboard list.
// This is effective because the props are unlikely to change unless the data for this specific card changes.
